...
save PAT_KORname_Standardized_`ver', replace



** Merge with KIS_KORnames and then Save matched and unmatched names, respectively.

run D:\KDI\Innovation\Code\Step3_KIS_KORname_Standardized.do
use KIS_KORname_Standardized, clear
merge 1:m name_kor using PAT_KORname_Standardized_`ver'
...
save PAT_KORname_Standardized_`ver'_unmatched, replace
restore
...
order pub_nr psn_name name_kor
sort psn_name name_kor
save PAT_KORname_Standardized_`ver'_matched, replace
