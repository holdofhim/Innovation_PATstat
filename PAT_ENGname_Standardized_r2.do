...
import excel using ReviewList\45000\KIS_PATSTAT_Matchinglist_45000_v2.xlsx, firstrow
merge n:1 psn_name using N_Patents_04_15
keep if _m==3
drop _merge
replace matched_name="" if matched_name=="0"
keep if matched_name==""

noi merge 1:m psn_name using D:\KDI\Innovation\Data\PATSTAT\table\dta\person_id_group
drop if _m==2
...
* 3. Clean data and save the result
	...
	order fid_pat
	save PAT_ENGname_Standardized_r2, replace
*/
